...
$(document).ready(function () {
   ...
   $('.Products__grid-item.Products__scroll-trigger.Products__animate--slide-in').click(function () {
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   window.onload = function () {
      ...
      filterValues.forEach(value => {
         const checkbox = document.querySelector(`.Products__filterppproducttype[value="${value}"]`)
         if (checkbox) {
      ...
      productItems.forEach(item => {
         item.addEventListener('click', () => {
            ...
            const checkbox = document.querySelector(`.Products__filterppproducttype[value="${itemId}"]`)
...
$(function () {
   ...
   const checkboxes = document.querySelectorAll('input[type="checkbox"][name="filter.p.product_type"]')
