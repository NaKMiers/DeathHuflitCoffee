...
const KproductDetail__main__text__size__choice__text =
   KproductDetail__main__text__size__choice.querySelectorAll(
      '.KproductDetail__main__text__size__choice__text'
   )
...
// type
const mainnElement = document.querySelector(
   '.KproductDetail__main__text__size2 .KproductDetail__main__text__size__mainn2'
)
