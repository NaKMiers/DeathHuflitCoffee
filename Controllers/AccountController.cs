...
//có mục đích chuyển đổi đối tượng recommendProducts (một danh sách các sản phẩm) thành một chuỗi JSON
        ...
        public IActionResult Index()
        {
            ...
            //Nếu người dùng đã đăng nhập, giá trị này sẽ chứa ID của người dùng.
...
//Dòng mã này in ra Console thông tin về email và mật khẩu từ đối tượng loginRequest. Điều này giúp kiểm tra xem dữ liệu nhập vào từ người dùng có được đọc đúng hay không.
